<?php
session_start();
include ('manager_leave.php');
?>
<!--
- Author: Maria Kouppi
-
- This file is a php file for leave request functionality that a manager can do. At the top of the page you will see
- the menu with the other features you can do on this web page. The managers give the date which the managers want to
- start the leave, the date which the managers want to return from leave and the reason which want to leave. For
...
- screen). If the managers press the button ‘Cancel’ which is on the screen, an alert box will appears and pressing
- the button ‘OK’,  the request will not be submit and the screen now will be your Dashboard ( manager). At
    ...
    <div class="logo">
        ...
        <ul>
            <label class="nav">
                ...
                <li><a href="leave_request_manager.php" style="color:orange;text-decoration: underline">Leave
                    Request</a></li>
...
<div>
    ...
    <form class="username" action="<?php $_SERVER['PHP_SELF'];?>" method="POST" id="form_id">
        <div class="aligncenter">
            ...
            <label id="label" for="textinput2"><b>REQUEST DAYS FROM:</b></label>
            ...
            <label id="label" for="textinput3"><b>REQUEST DAYS TO:</b></label>
            ...
            <label id="label" for="textinput4"><b><label style="color:red">*</label>Description :</b></label>
            <!-- and the reason which want to leave-->
            <input id="textinput4" name="desc" type="text">
            <br>
