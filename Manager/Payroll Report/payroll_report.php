...
<html lang="en">
	...
	<body>
			...
			<div class="logo">
				...
				<ul>
					<label class="nav">
						...
						<li><a href="payroll_report.html" style="color:orange;text-decoration: underline">Payroll Report</a></li>
						<li class="dropdown">
		...
		<form name="form_id"  id="form_id" class="username" method="post" action="<?php $_SERVER['PHP_SELF'];?>">
			<div >
				<label  id="label" for="textinput1" ><b>From :</b></label> 
				<input id="textinput1" name="from_date" type="date" placeholder=""  required="">
							
				<br>
				<br>
				<label id="label" for="textinput2"> <b>To :</b></label>
				...
				<br>
				<br>
				<label style="margin-left:415px"><b>Format : </b></label>
