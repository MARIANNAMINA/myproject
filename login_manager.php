...
<html lang="eng">
  ...
  <body>
	...
	<label ><a href="contact_manager_login.html" class="logout">Contact us</a></label>
	  ...
	  <label for="companyname"  style="font-size: 50pt;"> <b>Statare Brands LTD </b></label>
			...
			<form action="function_login_manager.php" method="post">
				<br>
				<div class="username">
					<label  for="textinput"  ><b>Username :</b></label> 
					<input style="margin-left:20px" id="textinput" name="name" type="text" placeholder=""  required="">
