...
}else if (strcmp($_POST['Password'],"******")!=0){ 
...
//	if( empty($phone_error) && empty($emergency_phone_error) && empty($email_error) && empty($country_num_error) && empty($address_error) && empty($birthdate_error)){
	...
	//	if($flag){
	//	
		$sqlUpdate = "UPDATE Employee SET Password = '$Hashed',Name = '$FirstName', Surname = '$LastName', Phone = '$Phone', EmergencyPhone = '$EmergencyPhone', Country = '$Country', Address = '$Address', Gender = '$Gender' WHERE Username = '$_SESSION[username]'";
